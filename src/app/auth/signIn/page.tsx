  ...
  return (
    <div className="flex w-full h-full justify-center items-center px-4">
      <div className="flex flex-col bg-white max-w-md w-full h-fit border border-gray-400 p-4 rounded-xl mb-40">
        ...
        <span className="text-black/50 mb-4">Please sign in to your account</span>
        <button className="flex gap-2 border border-gray-400 py-3 hover:bg-black/10 rounded-xl items-center justify-center" onClick={() => signIn("google")}>
